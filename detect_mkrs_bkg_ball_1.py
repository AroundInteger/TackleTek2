...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 19 18:30:18 2024
...
def create_debug_view(frame, fg_mask, bg_model):
    ...
    # Labels on left side with dark background for visibility
...
def main():
    ...
    # Set up video writer
    output_path = 'rugby_analysis_debug_output.mp4'
    ...
    #cv2.moveWindow('Rugby Analysis', height + 50, 0)  # Position to the right of debug view
    ...
    try:
        while True:
            ...
            # Draw ball position and trail if detected
