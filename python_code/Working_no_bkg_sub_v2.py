...
def process_video(input_path, output_path, output_folder):
    ...
    # Create CSV file for storing landmark data
    csv_path = os.path.join(output_folder, "landmark_data.csv")
    with open(csv_path, 'w', newline='') as csvfile:
        csv_writer = csv.writer(csvfile)
        # Write header
        header = ['frame'] + [f'{i}_{coord}' for i in range(33) for coord in ['x', 'y', 'z', 'visibility']]
    ...
    print(f"Landmark data saved to {csv_path}")

# Example usage
input_video = "/Users/Rowan/Library/CloudStorage/OneDrive-SwanseaUniversity/Research/TackleTek/R1_2.mp4"
output_video = "/Users/Rowan/Library/CloudStorage/OneDrive-SwanseaUniversity/Research/TackleTek/R1_2_multi_pose.mp4"
output_folder = "/Users/Rowan/Library/CloudStorage/OneDrive-SwanseaUniversity/Research/TackleTek/R1_2_multi_frames"
