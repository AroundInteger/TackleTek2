...
def create_debug_view(frame, fg_mask, bg_model, grid_points, h_lines, v_lines, stable_markers):
    ...
    with grid overlay on all panels
    """
    # Get dimensions
    ...
    mask_with_grid = draw_masked_grid(mask_colored, grid_points, h_lines, v_lines, stable_markers, np.zeros_like(fg_mask))
