...
def draw_annotations(frame, ball_carrier, tackler, head_positions, shoulder_positions, waist_positions):
    ...
    # Label players
    cv2.putText(frame, "Ball Carrier", (int(ball_carrier[0][0]), int(ball_carrier[0][1]) + 30), 
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)  # White for ball carrier
    cv2.putText(frame, "Tackler", (int(tackler[0][0]), int(tackler[0][1]) + 30), 
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 2)  # Yellow for tackler
