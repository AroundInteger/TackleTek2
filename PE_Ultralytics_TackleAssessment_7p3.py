...
def draw_annotations(frame, ball_carrier, tackler, ball_carrier_history, tackler_history):
    ...
    colors = {
        ...
        'tackler_head': (255, 255, 255),          # White
    ...
    draw_square(frame, ball_carrier[9], 20, colors['ball_carrier_wrist'])   # Left wrist
    draw_square(frame, ball_carrier[10], 20, colors['ball_carrier_wrist'])  # Right wrist
    draw_square(frame, tackler[0], 20, colors['tackler_head'])              # Head
...
for codec, ext in codecs:
    output_path = f'TackleTEK Video Quality Test R1{ext}'
...
# Prepare CSV file
csv_filename = 'tackle_analysis_TackleTEK Video Quality Test R1.csv'
